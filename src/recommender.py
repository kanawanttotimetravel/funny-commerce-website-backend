...
class RecommendationSystem(object):
    ...
    def matrix_construction(self):
        ...
        pivot_table = pd.pivot_table(self.rating_data, values='rating', index='user_id', columns='product_id')
    ...
    def similarities(self):
        ...
        pd.DataFrame(matrix).to_csv('../data/similarities_matrix.csv', index=False)
...
#     rcm.similarities()
    ...
    # rcm.matrix_construction()
    # rcm.similarities()
    # print(rcm.similarities_matrix.iloc[0].value_counts())
